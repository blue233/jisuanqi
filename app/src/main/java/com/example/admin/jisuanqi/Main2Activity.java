...
public class Main2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int itemWidth ;
        mEditInput = (EditText) findViewById(R.id.edit_input1);

        mEditInput.setMinHeight(5);
      //  mEditInput.setKeyListener(null);
        mGridView = (GridView) findViewById(R.id.grid_buttons1);
        // 创建适配器
        ...
        Button btn = (Button) this.findViewById(R.id.bt_science1);
        ...
        final Button bt_menu=(Button)findViewById(R.id.bt_menu1);
        bt_menu.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v) {
                showPopupMenu(bt_menu);
            }
        });
        Button btc=(Button)findViewById(R.id.bt_c1);
        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                if(item.getTitle().equals("面积")){
                    ...
                    Intent intent= new Intent(Main2Activity.this,AreaActivity.class);
                    startActivity(intent);
                }
                if(item.getTitle().equals("长度")){
                    Toast.makeText(getApplicationContext(), item.getTitle(), Toast.LENGTH_SHORT).show();
                    Intent intent= new Intent(Main2Activity.this,LengthActivity.class);
                    startActivity(intent);
                }
                if(item.getTitle().equals("温度")){
                    Toast.makeText(getApplicationContext(), item.getTitle(), Toast.LENGTH_SHORT).show();
                    Intent intent= new Intent(Main2Activity.this,TemperatureActivity.class);
                    startActivity(intent);
                }
                if(item.getTitle().equals("体积")){
                    Toast.makeText(getApplicationContext(), item.getTitle(), Toast.LENGTH_SHORT).show();
                    Intent intent= new Intent(Main2Activity.this,VolumeActivity.class);
                    startActivity(intent);
                }
                if(item.getTitle().equals("质量")){
                    Toast.makeText(getApplicationContext(), item.getTitle(), Toast.LENGTH_SHORT).show();
                    Intent intent= new Intent(Main2Activity.this,QualityActivity.class);
                    startActivity(intent);
                }
                ...
                if(item.getTitle().equals("进制转换")){
                    Toast.makeText(getApplicationContext(), item.getTitle(), Toast.LENGTH_SHORT).show();
                    Intent intent= new Intent(Main2Activity.this,JinzhiActivity.class);
                    startActivity(intent);
                }
                return false;
            }

...
public class JinzhiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Spinner spinner1 = (Spinner) findViewById(R.id.spinner_jinzhi1);
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this,
                R.array.jinzh_items, android.R.layout.simple_spinner_item);
        ...
        Spinner spinner2 = (Spinner) findViewById(R.id.spinner_jinzhi2);
